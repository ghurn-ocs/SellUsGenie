...
-- Corrected: Only includes tables that actually exist in the schema
...
-- Attribution touchpoints table indexes
...
-- Analyze all existing tables to update query planner statistics
...
ANALYZE page_history;
ANALYZE store_page_layouts;
ANALYZE store_policies;
...
-- 6. Page document retrieval and navigation queries
